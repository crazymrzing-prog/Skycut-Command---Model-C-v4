...
the exact names skycut_command_model_c.py's collect_layer() searches
for (see SOURCE_LAYER_NAMES in skycut_c_constants.py), plus Print and
...
skycut_command_model_c.py's effect() when Output is set to "Layer
...
from skycut_c_constants import PREVIEW_COLORS, SOURCE_LAYER_NAMES
...
# skycut_command_model_c.py calls run_layer_setup() directly instead)
# ==========================================================
